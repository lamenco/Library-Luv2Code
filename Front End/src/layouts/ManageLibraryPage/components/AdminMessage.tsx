...
export const AdminMessage: React.FC<{ message: MessageModel, submitResponseToQuestion: any }> = (props, key) => {
    ...
    return (
        <div key={props.message.id}>
            <div className="card mt-2 shadow p-3 bg-body rounder">
                <h5>Case  id={props.message.id}: {props.message.title}</h5>
                ...
                <div>
                    ...
                    <form action="PUT">
                        {displayWarning && <div className="alert alert-danger" role="alert">
                            All fields must e filled out.
                        </div>
                        }
                        <div className="col-md-12 mb-3">
                            <label className="form-label">Description</label>
                            <textarea className="form-label" id="exampleFormContorlTextArea1" rows={3}
